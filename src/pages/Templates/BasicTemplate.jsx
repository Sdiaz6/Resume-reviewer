...
export default function BasicTemplate({ basicInfo = {}, summary = "", experience = [], education = [], skills = [], color = "#3b82f6" }) {
  return (
    <div style={{ color: "#0f172a", fontFamily: "Inter, system-ui, sans-serif", fontSize: "11px", lineHeight: "1.4" }}>
      <header style={{ borderBottom: `3px solid ${color}`, paddingBottom: "12px", marginBottom: "14px" }}>
        ...
        <section style={{ marginBottom: "14px" }}>
          ...
          {experience.map((e, i) => (
            <div key={i} style={{ marginBottom: "8px" }}>
              <strong style={{ fontSize: "11px" }}>{e.role || "Role"}</strong> — <span style={{ color: "#374151", fontSize: "10px" }}>{e.company}</span>
